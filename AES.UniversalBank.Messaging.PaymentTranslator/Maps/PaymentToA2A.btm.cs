namespace AES.UniversalBank.Messaging.PaymentTranslator.Maps {
    ...
    public sealed class PaymentToA2A : global::Microsoft.XLANGs.BaseTypes.TransformBase {
  ...
  <xsl:template match=""/s0:AuthPaymentRequest"">
    <ns0:AccountPayment>
      ...
      <Amount>
        ...
        private const string _strTrgSchemasList0 = @"AES.UniversalBank.Messaging.PaymentTranslator.A2APayment";
        
        private const global::AES.UniversalBank.Messaging.PaymentTranslator.A2APayment _trgSchemaTypeReference0 = null;
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"AES.UniversalBank.Messaging.PaymentTranslator.A2APayment";
                return _TrgSchemas;
            }
        }
    }
