namespace AES.UniversalBank.Messaging.PaymentTranslator {
    ...
    [Schema(@"http://www.universalbank.com/aes/payment/mapping",@"ACH")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"ACH"})]
    public sealed class ACHPayment : Microsoft.XLANGs.BaseTypes.SchemaBase {
